...
function updateUiForAmp()
    ...
    local saggingLabel18Comp = panel:getComponent("saggingLabel18")
    local saggingLabel27Comp = panel:getComponent("saggingLabel27")
    local saggingLabel36Comp = panel:getComponent("saggingLabel36")
    local saggingLabel45Comp = panel:getComponent("saggingLabel45")
    ...
    if isBs200() then
        ...
        saggingLabel18Comp:setVisible(true)
        saggingLabel27Comp:setVisible(true)
        saggingLabel36Comp:setVisible(true)
        saggingLabel45Comp:setVisible(true)
        ...
        saggingLabel18Comp:setVisible(false)
        saggingLabel27Comp:setVisible(false)
        saggingLabel36Comp:setVisible(false)
        saggingLabel45Comp:setVisible(false)
